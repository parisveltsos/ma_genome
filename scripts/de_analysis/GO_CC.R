...
myGOdata <- new("topGOdata", description="My project", ontology="CC", nodeSize=5, allGenes=geneList_pvalues, geneSel=topDiffGenes, annot = annFUN.gene2GO, gene2GO = geneID2GO)
# myGOdata
...
# pdf(paste(output_file, 'CC_KS_vs_Fisher.pdf', sep=""))
# par(mar=c(5,5,4,3))
